...
public class Utils {
    ...
    /**
     * 是否为禁用股票，逗号分隔
     * @param prohibitSecuritiesStr
     * @param tradingCode
     * @return
     */
    public static boolean isProhibitSecurity(String prohibitSecuritiesStr, String tradingCode){
        boolean flag = false;
        if(prohibitSecuritiesStr != null && !"".equals(prohibitSecuritiesStr)){
            String[] prohibitSecuritiesArray = prohibitSecuritiesStr.split(",");
            if(prohibitSecuritiesArray != null && prohibitSecuritiesArray.length > 0){
                for(String prohibitSecurity : prohibitSecuritiesArray){
                    if(tradingCode.equals(prohibitSecurity)){
                        flag = true;
                        break;
                    }
                }
